This is a new Shared Collection (integration settgings) to be use in Cenit, named cenit-collection-ecommerce.

Cenit is an open source social platform as a service for data and business integration.

# CenitCollectionEcommerce
...
% tree
.
├── cenit-collection-cenit-collection-ecommerce.gemspec
├── Gemfile
├── .gitignore
├── .rspec
├── README.md
    ...
    └── cenit
        └── collection
            └── cenit-collection-ecommerce
                 ...
                 └── build.rb
                 └── version.rb
            └── cenit-collection-ecommerce.rb
└── spec
    └── cenit
        └── collection
            └── cenit-collection-ecommerce_spec.rb
    └── spec_helper.rb
    └── support
        └── samples
```
