...
Jeweler::Tasks.new do |gem|
  ...
  gem.name = 'cenit-collection-ecommerce'
  gem.license = "MIT"
  gem.summary = 'Shared Collection cenit-collection-ecommerce to be use in Cenit'
  gem.description = 'Shared Collection cenit-collection-ecommerce to be use in Cenit'
  gem.author = 'Asnioby Hdez'
  gem.email = 'asnioby@gmail.com'
  gem.homepage = 'https://github.com/asnioby/cenit-collection-ecommerce'
...
task :create_repo do
  options = {
    project_name: 'cenit-collection-ecommerce', 
    user_name: 'Asnioby Hdez', 
    user_email: 'asnioby@gmail.com',
    github_username: 'asnioby',
    summary: 'Shared Collection cenit-collection-ecommerce to be use in Cenit',
    description: 'Shared Collection cenit-collection-ecommerce to be use in Cenit',
    homepage: 'https://github.com/asnioby/cenit-collection-ecommerce',
...
require File.expand_path(File.join(*%w[ lib cenit collection ecommerce]), File.dirname(__FILE__))
task :push do
...
Rake::RDocTask.new do |rdoc|
  ...
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title = "cenit-collection-ecommerce #{version}"
